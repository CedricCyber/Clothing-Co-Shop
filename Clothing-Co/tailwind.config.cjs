  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        mImage7: "url('./mensStyle/blueshirt.jpg')",
        mImage8: "url('./mensStyle/pinkshirt.jpg')",
        wImage1: "url('./womansStyle/blackcoat.jpg')",
        wImage2: "url('./womansStyle/blackoutfit.jpg')",
        wImage3: "url('./womansStyle/brownshirt.jpg')",
        wImage4: "url('./womansStyle/greenblazer.jpg')",
        wImage5: "url('./womansStyle/greyblazer.jpg')",
        wImage6: "url('./womansStyle/pinkseater.jpg')",
